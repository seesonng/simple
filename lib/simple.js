        ...
        ...Object.assign({
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: 173,
              newsletterName: `✨Ping: ${(performance.now() - pingms).toFixed(2)}ms. || ${textsaluran}`,
            },
          },
        }),
      });
    ...
    if (json.url) {
        ...
        let mediaMessage = await prepareWAMessageMedia({
            ...(mime === "image" ? { image: file.data } : 
               ...
               { document: file.data, mimetype: file.mime, fileName: json.filename || "Nazir" + extension(file.mime) }),
        }, { upload: conn.waUploadToServer });
            ...
            jid, {
                viewOnceMessage: {
                    message: {
                        ...
                        interactiveMessage: proto.Message.InteractiveMessage.create({
                            body: proto.Message.InteractiveMessage.Body.create({ text: json.body }),
                            footer: proto.Message.InteractiveMessage.Footer.create({ text: json.footer }),
                            header: proto.Message.InteractiveMessage.Header.create({
                                hasMediaAttachment: true,
                                ...mediaMessage
                            }),
...
exports.smsg = (conn, m, hasParent) => {
  ...
  m.reply = async (pesan, options) => {
    ...
    try {
      ...
      conn.reply(m.chat, pesan, e, yourqouted, a);
    }
  };
